...
public class AdminController extends HttpServlet {
    ...
    protected void suspendOrResumeMember(JDBCBean bean, HttpServletRequest request) {
        ...
        if (action.equalsIgnoreCase("suspend")) {
            ...
            bean.executeSQLUpdate("UPDATE members SET status='ACCEPTED' WHERE id='" + requestedMemberID + "'");
            bean.executeSQLUpdate("UPDATE users SET status='ACCEPTED' WHERE id='" + requestedMemberID + "'");
        }
