...
<div class="content">
    ...
    <form action="${pageContext.request.contextPath}/AdminController" method="post">    
        ...
        <button class="btn" type="submit" name="manageClaimAction" value="accept_${requestedMember[0]}">Accept</button>
        <button class="btn" type="submit" name="manageClaimAction" value="regect_${requestedMember[0]}">Reject</button>
    </form> 
</div>
